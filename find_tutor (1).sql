...
INSERT INTO `payment` (`tutor_id`, `payee_id`) VALUES
(11, 10),
(12, 10),
(11, 10),
(14, 10),
...
--
-- Table structure for table `payment_tuition`
--

CREATE TABLE `payment_tuition` (
  `id` int(11) DEFAULT NULL,
  `payee_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `payment_tuition`
--

INSERT INTO `payment_tuition` (`id`, `payee_id`) VALUES
(4, 10),
(2, 10),
(3, 10),
(4, 9);
...
INSERT INTO `salary` (`salary_range`) VALUES
('1000 - 2000 tk'),
('2000 - 3000 tk'),
('4000 - 5000 tk'),
('6000 - 7000 tk'),
...
CREATE TABLE `tuitions` (
  ...
  `salary` varchar(29) DEFAULT NULL,
...
INSERT INTO `tuitions` (`id`, `district`, `area`, `subject`, `class`, `medium`, `salary`, `gender`, `hour`, `phone`, `email`, `user_id`) VALUES
(1, 'Rangpur', 'Pirgacha', 'Mathematics', 'Standard VI', 'Bangla Medium', '8000 - 9000 tk', 'Any', '6 hours', '02131231212', 'sdaf@gmail.com', 1324),
(2, 'Chattogram', 'Ashuganj', 'Law', 'Class VI', 'English Medium', '8000 - 9000 tk', 'Any', '5 hours', '02131231212', 'sdaf@gmail.com', 1234),
(3, 'Dinajpur', 'Atghoria', 'Islamic Studies', 'Class VII', 'Arabic Medium', '8000 - 9000 tk', 'Any', '5 hours', '02131231212', 'sdaf@gmail.com', 1324),
(4, 'Bogura', 'Alamdanga', 'Civics', 'Class VI', 'English Medium', '8000 - 9000 tk', 'Any', '5 hours', '1788189509', 'abdus@salam.com', 11),
(5, 'Dinajpur', 'Ashuganj', 'Sociology', 'Class IX', 'Bangla Medium', '4000 - 5000 tk', 'Any', '7 hours', '01788189509', 'mansura@gmail.com', 10);
...
INSERT INTO `tutors` (`id`, `qualification`, `subject`, `class`, `medium`, `salary`, `gender`, `experience`, `hour`) VALUES
(11, 'BSc in Engineering(RUET)', 'Civics', 'Class VII', 'English Medium', '10000 - 11000 tk', 'Male', 'assdfs', '6 hours'),
(12, 'BSc in Engineering(RUET)', 'Economics', 'Class V', 'Bangla Medium', '10000 - 11000 tk', 'Female', 'asdsafsda', '6 hours'),
(14, 'BSc in Engineering(RUET)', 'Biology', 'Class II', 'Arabic Medium', '8000 - 9000 tk', 'Male', 'wsdfasdf', '6 hours'),
(16, 'BSc in Engineering(RUET)', 'Sociology', 'Class IV', 'Bangla Medium', '8000 - 9000 tk', 'Male', 'fsddsfa', '6 hours'),
(17, 'BSc in Engineering(RUET)', 'Sociology', 'Class VI', 'Bangla Medium', '8000 - 9000 tk', 'Male', 'afsd', '6 hours'),
(18, 'BSc in Engineering(RUET)', 'Sociology', 'Class IV', 'Arabic Medium', 'All Salary Range', 'Male', 'dfsaf', '6 hours'),
(19, 'BSc in Engineering(RUET)', 'Statistics', 'Class III', 'Bangla Medium', '4000 - 5000 tk', 'Female', 'dasfsdafa', NULL);
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `tutor`, `img`, `district`, `area`, `phone`) VALUES
(9, 'sm@gmail.com', 'S M Nahid Hasan', '$2y$10$55X/2sdhbmLcnnuMr1KOp.3NmbrqrI4FhXE75u0KtDW55vjUMlwOG', 1, '1639767901_images.jpg', 'Comilla', 'Araihazar', 1788189509),
(10, 'mansura@gmail.com', 'Mansura Naznine', '$2y$10$Ap0olaa0tf8Hg.wSFSazXuTumoHHa1vv2xZ8Cw5P5NUMZc6CCWWRa', 0, '1639770960_images (2).jpg', 'Dhaka', 'Ashuganj', 1788189509),
(11, 'abdus@salam.com', 'Abdus Salam', '$2y$10$xhlHUkbuqNbb0lB97WKHeu.2tstfvo8jnv0Tg62Z14xqwRi5fLJLe', 1, '1639771239_images (4).jpg', 'Dinajpur', 'Assasuni', 1788189509),
(12, 'emu@emu.com', 'Emama Nahid', '$2y$10$xUyg8WtLeW2Pmw2br7j4VOLBVLzKBNQeG2/RMOweqajbRZxSWPmB.', 1, '1639771325_images (3).jpg', 'Dinajpur', 'Araihazar', 1788189509),
(14, 'habib@gmail.com', 'Habib Ur Rahman', '$2y$10$2D.hp9Y/HQ0QEQRm.1iUlOhYLJyCAjRTu6jjMZMKLlz3MKO/jQNAO', 1, '1639815084_images (3).jpg', 'Dhaka', 'Anwara', 1788189509),
(15, 'dfs@gmail.comg', 'fad', '$2y$10$I6uDr8UME3WWdbakq4JCiu3xLMn0Pt74FxfQqsZoJ46P1gIOCqSmy', 0, '1639828147_images.jpg', 'Faridpur', 'Assasuni', 0),
(16, 'ronok@gmail.com', 'Ronok', '$2y$10$NKjex8VHzrz8axbxblu3qe9x4liPoP2rCEGr8omj/nMULu4Yf9awG', 1, '1639849288_images (1).jpg', 'Dinajpur', 'Adamdighi', 1788189509),
(17, 'musa@gmail.com', 'Ahmed Musa', '$2y$10$hchmI4meezK3hIFYogkevu9r2SQdpZmojKZdPjeh58d9tff.Ti1dm', 1, '1639849337_images (3).jpg', 'Coxsbazar', 'Atrai', 1788189509),
(18, 'jami@gmail.com', 'Jamiul Haque', '$2y$10$BVUKLwbxx1C3FkZ4W/DQS.amY5ke11Qje8E7QwPBMBhkiyf1femuW', 1, '1639849398_images.jpg', 'Gaibandha', 'Atpara', 1788189509),
(19, 'rasha@gmail.com', 'Hasnin Jerin Rasha', '$2y$10$.m9/9yAL4.CccNoykHF1AeTCZGEoiGAoDvteqrr0QX7rFMIO4qfLm', 1, '1639890467_images (3).jpg', 'Dinajpur', 'Atwari', 1788189509);
