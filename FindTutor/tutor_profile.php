...
$tutor =  selectOne('tutors', ['id' => $_GET['id']]);
...
if(!empty($_SESSION['id']))
{
   ...
   $payment =  selectOne('payment', $conditon);
}
...
<?php include(ROOT_PATH . "/app/includes/messages.php"); ?>
   ...
   <div class="container">
      ...
      <?php if (!empty($_SESSION['id']) && empty($payment)): ?>
      <div class="button-2">
               <input type="button" onclick="document.location=' <?php echo BASE_URL . '/payment.php' . '?id='; echo $tutor['id']; ?>'" value="Get Contact Info" >
            </div>
      <?php endif; ?>                 
